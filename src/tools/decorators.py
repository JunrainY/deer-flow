...
def tool(func: Callable) -> Callable:
    """
    A simple tool decorator for marking functions as tools.

    Args:
        func: The function to be decorated as a tool

    Returns:
        The original function (for now, just a marker decorator)
    """
    # For now, this is just a marker decorator
    # In a full implementation, this might register the tool or add metadata
    func._is_tool = True
    return func
